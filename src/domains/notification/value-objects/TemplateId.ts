 ...
 *
 * Immutable value object representing a notification template identifier.
...
export class TemplateId {
  ...
  /**
   * Creates a TemplateId from a string value.
  ...
  /**
   * Reconstructs a TemplateId from a value that was already validated.
   * Use this only when the value is guaranteed to be valid.
   * @param value The UUID string
   * @returns A new TemplateId instance
   */
  public static reconstruct(value: string): TemplateId {
    return new TemplateId(value);
  }

  /**
   * Generates a new random TemplateId.
   * @returns A new TemplateId instance
   */
  ...
  /**
   * Checks equality with another TemplateId.
   * @param other The other TemplateId to compare
  ...
  /**
   * Returns the string representation of the TemplateId.
   */
