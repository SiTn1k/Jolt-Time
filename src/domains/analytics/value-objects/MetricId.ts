 ...
 *
 * Immutable value object representing an analytics metric identifier.
...
export class MetricId {
  ...
  /**
   * Creates a MetricId from a string value.
   * Validates that the value is a non-empty, valid UUID format.
   * @param value The UUID string
   * @returns A new MetricId instance
  ...
  /**
   * Reconstructs a MetricId from a value that was already validated.
  ...
  /**
   * Generates a new random MetricId.
   * @returns A new MetricId instance
   */
   ...
   * @param other The other MetricId to compare
   * @returns true if values are equal
   */
  public equals(other: MetricId): boolean {
    if (!(other instanceof MetricId)) {
      return false;
    }
  ...
  /**
   * Returns the string representation of the MetricId.
   */
