// 12 Epochs of Ukrainian History + 12 World History Epochs (Prestige 1+)
export type EpochId =
  | 'trypillia'        // 1-50
  | 'scythia'          // 51-100
  | 'antiquity'        // 101-150
  ...
  | 'egypt'            // Prestige 1, levels 1000-1100
  | 'rome'             // Prestige 1, levels 1101-1200
  | 'china'            // Prestige 2, levels 1201-1300
  | 'byzantine'        // Prestige 2, levels 1301-1400
  | 'medieval'         // Prestige 3, levels 1401-1500
  | 'ottoman'          // Prestige 3, levels 1501-1600
  | 'renaissance'      // Prestige 4, levels 1601-1700
  | 'discovery'        // Prestige 4, levels 1701-1800
  | 'revolution_era'   // Prestige 5, levels 1801-1900
  | 'industrial'       // Prestige 5, levels 1901-2000
  | 'civil_war_era'    // Prestige 6, levels 2001-2100
  | 'meiji';           // Prestige 6, levels 2101-2200
...
export interface Epoch {
  ...
  unlockLevel: number;
  requiredPrestige?: number; // For world history epochs (Prestige 1+)
  currency: string;
  currencyIcon: string;
