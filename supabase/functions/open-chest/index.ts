...
const ARTIFACTS: Array<{
  ...
  // Egypt
  { id: "egypt_scarab", epoch: "egypt", rarity: "common", parts: 10, bonus: { type: "xp_multiplier", value: 1.08 }, icon: "🪲", name: { ua: "Скарб", en: "Scarab" }, requiredPrestige: 1 },
  { id: "egypt_anubis", epoch: "egypt", rarity: "rare", parts: 10, bonus: { type: "passive_boost", value: 1.12 }, icon: "🐺", name: { ua: "Статуя Анубіса", en: "Anubis Statue" }, requiredPrestige: 1 },
  { id: "egypt_mask", epoch: "egypt", rarity: "legendary", parts: 10, bonus: { type: "xp_multiplier", value: 1.25 }, icon: "👑", name: { ua: "Маска Тутанхамона", en: "Tutankhamun Mask" }, requiredPrestige: 1 },
  // Rome
  { id: "rome_gladius", epoch: "rome", rarity: "common", parts: 10, bonus: { type: "xp_multiplier", value: 1.08 }, icon: "🗡️", name: { ua: "Гладіус", en: "Gladius" }, requiredPrestige: 1 },
  { id: "rome_eagle", epoch: "rome", rarity: "rare", parts: 10, bonus: { type: "currency_multiplier", value: 1.12 }, icon: "🦅", name: { ua: "Орел легіону", en: "Legion Eagle" }, requiredPrestige: 1 },
  { id: "rome_laurel", epoch: "rome", rarity: "legendary", parts: 10, bonus: { type: "passive_boost", value: 1.25 }, icon: "🌿", name: { ua: "Імператорський вінок", en: "Imperial Laurel" }, requiredPrestige: 1 },
  // China
  { id: "china_jade", epoch: "china", rarity: "common", parts: 10, bonus: { type: "currency_multiplier", value: 1.08 }, icon: "🐉", name: { ua: "Нефритовий дракон", en: "Jade Dragon" }, requiredPrestige: 2 },
  { id: "china_bell", epoch: "china", rarity: "rare", parts: 10, bonus: { type: "passive_boost", value: 1.12 }, icon: "🔔", name: { ua: "Дзвін династії Цінь", en: "Qin Dynasty Bell" }, requiredPrestige: 2 },
  { id: "china_scroll", epoch: "china", rarity: "legendary", parts: 10, bonus: { type: "xp_multiplier", value: 1.25 }, icon: "📜", name: { ua: "Імператорський указ", en: "Imperial Scroll" }, requiredPrestige: 2 },
  // Byzantine
  { id: "byzantine_mosaic", epoch: "byzantine", rarity: "common", parts: 10, bonus: { type: "passive_boost", value: 1.08 }, icon: "🎨", name: { ua: "Мозаїка", en: "Mosaic" }, requiredPrestige: 2 },
  { id: "byzantine_crown", epoch: "byzantine", rarity: "rare", parts: 10, bonus: { type: "currency_multiplier", value: 1.12 }, icon: "👑", name: { ua: "Вінець імператора", en: "Emperor Crown" }, requiredPrestige: 2 },
  { id: "byzantine_icon", epoch: "byzantine", rarity: "legendary", parts: 10, bonus: { type: "xp_multiplier", value: 1.25 }, icon: "🖼️", name: { ua: "Ікона Вседержитель", en: "Pantocrator Icon" }, requiredPrestige: 2 },
  // Medieval
  { id: "medieval_sword", epoch: "medieval", rarity: "common", parts: 10, bonus: { type: "xp_multiplier", value: 1.08 }, icon: "⚔️", name: { ua: "Меч хрестоносця", en: "Crusader Sword" }, requiredPrestige: 3 },
  { id: "medieval_shield", epoch: "medieval", rarity: "rare", parts: 10, bonus: { type: "passive_boost", value: 1.12 }, icon: "🛡️", name: { ua: "Гербовий щит", en: "Coat of Arms Shield" }, requiredPrestige: 3 },
  { id: "medieval_grail", epoch: "medieval", rarity: "legendary", parts: 10, bonus: { type: "currency_multiplier", value: 1.25 }, icon: "🏆", name: { ua: "Грааль", en: "Holy Grail" }, requiredPrestige: 3 },
  // Ottoman
  { id: "ottoman_turban", epoch: "ottoman", rarity: "common", parts: 10, bonus: { type: "passive_boost", value: 1.08 }, icon: "👳", name: { ua: "Тюрбан", en: "Turban" }, requiredPrestige: 3 },
  { id: "ottoman_dagger", epoch: "ottoman", rarity: "rare", parts: 10, bonus: { type: "xp_multiplier", value: 1.12 }, icon: "🗡️", name: { ua: "Ятаган", en: "Yatagan" }, requiredPrestige: 3 },
  { id: "ottoman_throne", epoch: "ottoman", rarity: "legendary", parts: 10, bonus: { type: "passive_boost", value: 1.25 }, icon: "🪑", name: { ua: "Трон султана", en: "Sultan Throne" }, requiredPrestige: 3 },
  // Renaissance
  { id: "renaissance_palette", epoch: "renaissance", rarity: "common", parts: 10, bonus: { type: "xp_multiplier", value: 1.08 }, icon: "🎨", name: { ua: "Палітра художника", en: "Artist Palette" }, requiredPrestige: 4 },
  { id: "renaissance_clock", epoch: "renaissance", rarity: "rare", parts: 10, bonus: { type: "passive_boost", value: 1.12 }, icon: "⏰", name: { ua: "Годинник да Вінчі", en: "Da Vinci Clock" }, requiredPrestige: 4 },
  { id: "renaissance_david", epoch: "renaissance", rarity: "legendary", parts: 10, bonus: { type: "currency_multiplier", value: 1.25 }, icon: "🗿", name: { ua: "Давид", en: "David" }, requiredPrestige: 4 },
  // Discovery
  { id: "discovery_compass", epoch: "discovery", rarity: "common", parts: 10, bonus: { type: "xp_multiplier", value: 1.08 }, icon: "🧭", name: { ua: "Компас", en: "Compass" }, requiredPrestige: 4 },
  { id: "discovery_telescope", epoch: "discovery", rarity: "rare", parts: 10, bonus: { type: "passive_boost", value: 1.12 }, icon: "🔭", name: { ua: "Телескоп", en: "Telescope" }, requiredPrestige: 4 },
  { id: "discovery_globe", epoch: "discovery", rarity: "legendary", parts: 10, bonus: { type: "xp_multiplier", value: 1.25 }, icon: "🌍", name: { ua: "Глобус", en: "Globe" }, requiredPrestige: 4 },
  // Revolution Era
  { id: "revolution_guillotine", epoch: "revolution_era", rarity: "common", parts: 10, bonus: { type: "passive_boost", value: 1.08 }, icon: "⚔️", name: { ua: "Модель гільйотини", en: "Guillotine Model" }, requiredPrestige: 5 },
  { id: "revolution_cockade", epoch: "revolution_era", rarity: "rare", parts: 10, bonus: { type: "currency_multiplier", value: 1.12 }, icon: "🎀", name: { ua: "Кокарда", en: "Cockade" }, requiredPrestige: 5 },
  { id: "revolution_code", epoch: "revolution_era", rarity: "legendary", parts: 10, bonus: { type: "passive_boost", value: 1.25 }, icon: "📖", name: { ua: "Кодекс Наполеона", en: "Napoleonic Code" }, requiredPrestige: 5 },
  // Industrial
  { id: "industrial_gear", epoch: "industrial", rarity: "common", parts: 10, bonus: { type: "passive_boost", value: 1.08 }, icon: "⚙️", name: { ua: "Зубчасте колесо", en: "Gear" }, requiredPrestige: 5 },
  { id: "industrial_loom", epoch: "industrial", rarity: "rare", parts: 10, bonus: { type: "currency_multiplier", value: 1.12 }, icon: "🧵", name: { ua: "Ткацький верстат", en: "Loom" }, requiredPrestige: 5 },
  { id: "industrial_telegraph", epoch: "industrial", rarity: "legendary", parts: 10, bonus: { type: "xp_multiplier", value: 1.25 }, icon: "📡", name: { ua: "Телеграф", en: "Telegraph" }, requiredPrestige: 5 },
  // Civil War Era
  { id: "civil_cannon", epoch: "civil_war_era", rarity: "common", parts: 10, bonus: { type: "xp_multiplier", value: 1.08 }, icon: "💣", name: { ua: "Гармата", en: "Cannon" }, requiredPrestige: 6 },
  { id: "civil_flag", epoch: "civil_war_era", rarity: "rare", parts: 10, bonus: { type: "passive_boost", value: 1.12 }, icon: "🇺🇸", name: { ua: "Прапор Союзу", en: "Union Flag" }, requiredPrestige: 6 },
  { id: "civil_emancipation", epoch: "civil_war_era", rarity: "legendary", parts: 10, bonus: { type: "currency_multiplier", value: 1.25 }, icon: "📜", name: { ua: "Прокламація", en: "Emancipation" }, requiredPrestige: 6 },
  // Meiji Japan
  { id: "meiji_katana", epoch: "meiji", rarity: "common", parts: 10, bonus: { type: "xp_multiplier", value: 1.08 }, icon: "⚔️", name: { ua: "Катана", en: "Katana" }, requiredPrestige: 6 },
  { id: "meiji_fan", epoch: "meiji", rarity: "rare", parts: 10, bonus: { type: "passive_boost", value: 1.12 }, icon: "🪭", name: { ua: "Віяло", en: "Fan" }, requiredPrestige: 6 },
  { id: "meiji_chrysanthemum", epoch: "meiji", rarity: "legendary", parts: 10, bonus: { type: "xp_multiplier", value: 1.25 }, icon: "🌸", name: { ua: "Хризантема", en: "Chrysanthemum" }, requiredPrestige: 6 },
];
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { telegram_id, epoch_id, chest_type = "daily" } = body;
    ...
    // NOTE: For daily chests, currency is deducted client-side (optimistic update).
    // Server only deducts for skychest (premium chests have no client-side deduction).
    const chestCost = chest_type === "skychest" ? 0 : 0;
